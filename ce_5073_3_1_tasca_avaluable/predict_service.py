...
def predict_k_nearest_neighbours(petal_length, petal_width, sc, model):
    """Do predictions with k-Nearest Neighbours model

    Args:
        petal_length (float): Length of petals in cm
        petal_width (float): Width of petals in cm
        sc (sklearn.preprocessing.StandardScaler): Standardized data model
        model (sklearn.neighbors.KNeighborsClassifier): k-Nearest Neighbours model
